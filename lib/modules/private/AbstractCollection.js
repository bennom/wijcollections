...
define( "wijcModules/private/AbstractCollection", ['md5/wiMD5'], function( MD5 ) {
    ...
    function AbstractCollection() {
        ...
        /**
         * Use the MD5 implementation for generating hash values.
         *
         * @protected
         * @method generateMd5
         * @param  {String} str String representation of any object
         * @return {String}     MD5 hash of the specified string
         */
    ...
    AbstractCollection.prototype.getHash = function( obj ) {
        if( obj !== undefined && obj !== null ) {
            ...
            if( obj.constructor !== String ) {
                return this.generateMd5( JSON.stringify( obj ) );
            } else {
                return this.generateMd5( obj );
            }
        }
